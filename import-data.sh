...
mongoimport -h $DB_HOST -d agora -u $DB_USER -p $DB_PASS --authenticationDatabase admin --collection genescoredistribution --json --drop --file $DATA_DIR/distribution_data.json
